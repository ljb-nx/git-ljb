...
class BaseMainWind ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.wxstaticText1 = wx.StaticText( self, wx.ID_ANY, u"主窗口测试", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.wxstaticText1.Wrap( -1 )
		self.wxstaticText1.SetFont( wx.Font( 12, 70, 90, 90, False, wx.EmptyString ) )
		
		bSizer1.Add( self.wxstaticText1, 0, wx.ALL, 5 )
